...
const Footer = () => (
    <footer>
        <p>
            ...
            on it. The game ends when all queens are placed to the board and no two queens share the same row, column,or
            diagonal.
        </p>
        ...
        <p>
            <strong>More:</strong> About the n-Queens puzzle{' '}
        ...
        <p>
            Created by <a href="https://github.com/tasos14">tasos14</a>, inspired by{' '}
            <a href="http://ng2048.github.io/" target="_blank" rel="noopener noreferrer">
                ng-2048
            </a>
            .
        </p>
